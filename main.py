...
async def run_claude_task(request: TaskRequest):
    ...
    # 环境变量配置 (从宿主机获取，保持安全性)
    # 硬编码模型配置为 minimax/minimax-m2.5
    hardcoded_model = "minimax/minimax-m2.5"
    ...
    env_vars = {
        ...
        "ANTHROPIC_MODEL": hardcoded_model,
        "ANTHROPIC_DEFAULT_HAIKU_MODEL": hardcoded_model,
        "ANTHROPIC_DEFAULT_OPUS_MODEL": hardcoded_model,
        "ANTHROPIC_DEFAULT_SONNET_MODEL": hardcoded_model,
        "ANTHROPIC_REASONING_MODEL": hardcoded_model,
